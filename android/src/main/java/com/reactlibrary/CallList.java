...
////        Log.d("CallList", "onCallAdded: callState=" + call.getState());
...
//        if (updateCallInMap(call)) {
//            Log.i("CallList", "onDisconnect: " + call);
...
//        if (updateCallInMap(call)) {
//            Log.i("CallList", "onIncoming - " + call);
//        }
...
//        Log.d("CallList", "onUpgradeToVideo call=" + call);
//
//        for (Listener listener : mListeners) {
...
//        return getFirstCallWithState(Call.STATE_SELECT_PHONE_ACCOUNT);
//    }
//    @RequiresApi(api = Build.VERSION_CODES.R)
...
//        Call call = getFirstCallWithState(Call.STATE_DIALING);
//        if (call == null) {
//            call = getFirstCallWithState(Call.STATE_DIALING);
//        }
//        return call;
//    }
//    @RequiresApi(api = Build.VERSION_CODES.R)
...
//        return getCallWithState(Call.STATE_HOLDING, 1);
//    }
//    @RequiresApi(api = Build.VERSION_CODES.R)
...
//        Call call = getFirstCallWithState(Call.STATE_RINGING);
//        if (call == null) {
//            call = getFirstCallWithState(Call.STATE_SIMULATED_RINGING);
//        }
//        return call;
//    }
//    @RequiresApi(api = Build.VERSION_CODES.R)
...
//        }
//        if (result == null) {
//            result = getFirstCallWithState(Call.STATE_ACTIVE);
//        }
//        if (result == null) {
...
//        final int state = call.getState();
//        return Call.STATE_NEW == state || Call.State.INVALID == state;
//    }
//    /**
